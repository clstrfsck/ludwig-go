...
// BenchmarkNewFilled benchmarks the NewFilled constructor
func BenchmarkNewFilled(b *testing.B) {
	for b.Loop() {
		_ = NewFilled('X')
	}
}

// BenchmarkClone benchmarks the Clone method
...
// BenchmarkEquals benchmarks the Equals method
func BenchmarkEquals(b *testing.B) {
	...
	s2.Assign("ABCDEFGH")
	for b.Loop() {
		_ = s1.Equals(s2, 8, 1, 1)
	}
}

// BenchmarkCopy benchmarks the Copy method
func BenchmarkCopy(b *testing.B) {
	src := NewFilled('A')
	dst := NewFilled(' ')
	for b.Loop() {
		dst.Copy(src, 1, 100, 1)
	}
}
